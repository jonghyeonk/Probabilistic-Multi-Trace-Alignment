...
class IndexNgramTransformer(TransformerMixin):
    
    def __init__(self, case_id_col: str, act_col: str, n: int, v: float, cat_cols: List[str], num_cols: List[str], max_events: int = None, fillna: bool = True, create_dummies: bool = True):
        """
        Parameters
        -------------------
        case_id_col
